<template>
  <v-app>
    <v-app-bar app>
      ...
      <v-btn to="/add/payment/Sport?value=200" plain :ripple="false"
        >Sport</v-btn
      >
      <v-btn to="/add/payment/Education?value=500" plain :ripple="false"
        >Education</v-btn
      >
      <v-btn plain :ripple="false" @click="dialogCategory = !dialogCategory"
        >Category <v-icon>mdi-plus</v-icon></v-btn
      >
    </v-app-bar>
